...
export const Profile = ({ memberId, onClose }: IProfileProps) => {
	const router = useRouter()
	const workspaceId = useWorkspaceId()

	const [UpdateDialog, confirmUpdate] = useConfirm('Change role', 'Are you sure you want to change this member role?')
